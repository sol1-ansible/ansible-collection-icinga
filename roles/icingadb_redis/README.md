...
> :information_source: In most scenarios you want to install the [icingadb role](https://github.com/NETWAYS/ansible-collection-icinga/tree/main/doc/role-icingadb/) together with this role. It is part of this collection, too.
...
There is a whole set of `defaults` in place for craeting a sane Redis installation. Should you need to fine-tune settings, please consult [the defaults at `icingadb_redis/defaults/main.yml`](https://github.com/NETWAYS/ansible-collection-icinga/tree/main/roles/icingadb_redis/defaults/main.yml) for the specific variables.
